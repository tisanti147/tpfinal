...
public class BaseDatos {
    ...
    public static Compañia levantarCompania() {
        ...
        try {
            if(!archivo.exists()) {
                ...
                compañia = mapper.readValue(new File("Compañia.json"), new TypeReference<Compañia>(){});
                /*company = compañia;*/

                company.setListaAviones(compañia.getListaAviones());
                company.setListaUsuario(compañia.getListaUsuario());
                company.setListaVuelos(compañia.getListaVuelos());
    ...
    public static void guardarCompania(Compañia company) {
        ...
        try {
            ...
            mapper.writeValue(new File("Compañia.json"), company);
