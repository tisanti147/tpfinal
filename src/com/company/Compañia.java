...
public class Compañia implements Serializable {
    ...
    public int gastosTotales (Usuario usuario){
        int gastos = 0;
        for (Vuelo vuelo: ListaVuelos){
            if (vuelo.getUsuario() == usuario)
                gastos += vuelo.getCostoTotal();
        }
        return gastos;
    }

    public void mostrarVuelosUsuario (Usuario usuario){
        for (Vuelo vuelo: ListaVuelos){
            if (vuelo.getUsuario() == usuario)
    ...
    public String mejorCategoria (Usuario usuario){
    ...
    public void addUsuario(Usuario user){
        user.setId(this.ListaUsuario.size());
