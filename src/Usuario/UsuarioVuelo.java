...
public class UsuarioVuelo extends Vuelo {
    ...
    public UsuarioVuelo(String fecha, int cantPasajeros, Avion avion, double costoTotal, Provincia origen, Provincia destino) {
        super(fecha, cantPasajeros, avion, costoTotal, origen, destino);
    }
