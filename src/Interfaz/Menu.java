...
public class Menu {
    ...
    private Compañia company = db.levantarCompania();
            ...
            case 3:
                ...
                do{
                    ...
                    if (user == null)
                        ...
                        dni2 = (int)user.getDni();
                    }
                } while (user == null);

                // Muestra los vuelos cargados en el usuario
                boolean comprobador = false;
                ArrayList<Vuelo> vuelosDeUsuario = company.getListaVuelos();

                for(Vuelo buscarVueloUsuario : vuelosDeUsuario ){
                    if(buscarVueloUsuario.estaUsuario((long)dni2)== true && buscarVueloUsuario.getUsuario()!= null){
                        comprobador = true;
                        user = buscarVueloUsuario.getUsuario();
                    }
                }
                ...
                user.mostrarVuelos();
                    ...
                    System.out.println("No hay vuelos reservados a ese DNI");
                }
            ...
            case 5:
                ...
                switch (swValue){
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println("Gastos totales: $" + Math.floor(company.gastosTotales(user)));
                        break;
                    case 3:
                        System.out.println("Membresía: " + company.mejorCategoria(user));
                        break;
                }
                ejecutarMenu();
                break;
